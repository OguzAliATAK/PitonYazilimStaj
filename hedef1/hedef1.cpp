...
void girileceksayilar(int a)
{
	...
	cout << "Fonksiyon :   "  << "(1.Değer - 2.Değer + (3.Değer] * 4.Değer]) / (5.Değer * 6.Değer))" << endl;
...
a:
	...
	cout << "Çıkmak için herhangi bir tuşa basınız";
	cin >> islem;
	switch (islem)
	{
	case 1: system("CLS");  goto a;
	default:
		break;
	}
